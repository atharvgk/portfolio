...
export const PROJECTS = [
    ...
    },
    {
        ...
        tech: ["React", "Node.js", "Express", "MongoDB", "Web Speech API", "OpenAI Whisper", "OpenWeatherMap API"],
    ...
    },
    {
        id: "ResumeForge",
        title: "ResumeForge",
        description: "An AI-powered resume builder with professional templates, real-time preview, and one-click PDF export to create ATS-optimized resumes quickly.",
        tech: ["Next.js", "TypeScript", "Tailwind CSS", "shadcn/ui", "Supabase", "Groq API", "Zustand", "Zod"],
        repo: "https://github.com/atharvgk/ResumeForge",
        live: "https://resume-forge-cyan-one.vercel.app/",
